...
/*import com.jht.model.BoardVO;
import com.jht.service.BoardService;*/
...
public class BoardController {
   ...
   @RequestMapping(value = "BoardViewList", method = RequestMethod.GET)
   public String boardviewlist() {   
//	      model.addAttribute("boardlist", bs.boardlist(list) );
	   
      return "board/list_BoardViewList";
   }

   @RequestMapping(value = "BoardViewDetail", method = RequestMethod.GET)
   public String boardviewdetail() {   
      return "board/detail_BoardViewDetail";
   }
   
   @RequestMapping(value = "BoardWriteForm", method = RequestMethod.GET)
   public String boardviewwirteform() {   
      return "board/write_BoardWriteForm";
   }
